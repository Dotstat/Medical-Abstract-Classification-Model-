...
def specialist_feats_for_k(keep_words_k, err_words_k, k, use_char, char_ngrams, char_min_df,
                           kw_weight, err_weight, char_weight):
    transformers = [
        ('tfidf', tfidf_base()),
...
def make_specialist(keep_words_k, err_words_k, k, use_calibration, **cfg):
    feats = specialist_feats_for_k(keep_words_k, err_words_k, k,
                                   cfg['use_char'], cfg['char_ngrams'], cfg['char_min_df'],
                                   cfg['kw_weight'], cfg['err_weight'], cfg['char_weight'])
